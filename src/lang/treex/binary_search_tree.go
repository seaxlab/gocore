...
import (
	"bytes"
	"fmt"
	"github.com/seaxlab/gocore/src/lang/comparex"
	"github.com/seaxlab/gocore/src/lang/listx"
	"github.com/seaxlab/gocore/src/lang/queuex"
)
...
func (tree *BSTree) add(n *BSTreeNode, e interface{}) *BSTreeNode {
	...
	// 递归调用
	ret, err := comparex.Compare(e, n.e)
	if err != nil {
...
func (tree *BSTree) LevelOrder() {
	// 使用我们之前实现的循环队列
	loopQueue := queuex.NewLoopQueue(20)
